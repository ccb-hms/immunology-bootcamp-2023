...
- [Single cell course materials](https://www.singlecellcourse.org/)
- [Offical Seurat tutorials](https://satijalab.org/seurat/) such as [Using sctransform in Seurat](https://satijalab.org/seurat/articles/sctransform_vignette.html) and [Cell-Cycle Scoring and Regression](https://satijalab.org/seurat/archive/v3.1/cell_cycle_vignette.html)
- [Extensive list of packages for single-cell analysis](https://github.com/seandavi/awesome-single-cell#awesome-single-cell)
